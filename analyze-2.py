...
dataFile = pd.read_csv('TestSortRuntime_100Samples2.csv', delimiter = ',')
input_size2 = dataFile['input_size']
ave_running_time2 = dataFile ['ave_running_time']

fig = plt.figure()
axes = fig.add_axes([0.1, 0.1,1.6,1.6])

axes.plot(input_size, ave_running_time, 'r', lw = 2, marker = 'o', markerfacecolor = 'black')
axes.plot(input_size2, ave_running_time2, 'b', lw = 2, marker = 'o', markerfacecolor = 'black')
